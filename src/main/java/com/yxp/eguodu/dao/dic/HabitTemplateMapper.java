...
public interface HabitTemplateMapper {
    ...
    @Select({"<script> " +
            ...
            "         mode,timeModeNum,countModeNum,valueModeNum,unitName from dic_habittemplate h  " +
    ...
    @Insert("<script>" +
            ...
            "   mode,timeModeNum,countModeNum,valueModeNum,unitName ) values ( func_makeDicId('habittemplate',''),#{habitTemplateName},#{habitClassId}," +
            "   #{subHabitClassId}, #{icon},#{color},#{memo},#{picUrl},#{perTime},#{timeUnit}, " +
            "   #{mode},#{timeModeNum},#{countModeNum},#{valueModeNum},#{unitName} )" +
            "</script>")
   ...
   @Update("<script>" +
           ...
           "           mode= #{mode},timeModeNum= #{timeModeNum},countModeNum= #{countModeNum},valueModeNum= #{valueModeNum},unitName= #{unitName} where habitTemplateId=  #{habitTemplateId}" +
           "</script>")
